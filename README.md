...
jobs:
  build:
    ...
    - name: Build conda package
      uses: prefix-dev/rattler-build-action@v0.2.3
```

> [!WARNING]
> Since rattler-build is still experimental and the API can change in minor versions, please pin this action to its minor version, i.e., `prefix-dev/rattler-build-action@v0.2.3`.
